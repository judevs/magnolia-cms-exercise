...
This package contains:
   ...
   Magnolia Core 6.4.1
   Magnolia empty webapp 6.4.1
   Magnolia empty webapp 6.4.1
   Magnolia Internationalization Framework 6.4.1
   Magnolia JAAS 6.4.1
   Magnolia Mail module 7.0.0
   Magnolia Rendering 6.4.1
   Magnolia Templating 6.4.1
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/6.4.1.html
...
Copyright 2003-2025 Magnolia International Ltd.
